...
(sentinelcore/api/v1/tool_call.py) needs to combine this engine's content-based
decision with a completely separate, deterministic tool-name authorization
lookup (sentinelcore/services/tool_policy.py) using the exact same severity
